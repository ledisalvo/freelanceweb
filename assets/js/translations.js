window.TRANSLATIONS = {
  en: {
    ...
    'skills.resume':    'Download Resume',
    'apps.title':       "What I've built",
    'apps.subtitle':    "Side projects and tools I've shipped.",
    'contact.title':    'Get In Touch',
    'contact.subtitle': 'Feel free to contact me, please complete the form below.<br />You will be redirected to WhatsApp.',
    'contact.name':     'Name',
    'contact.email':    'Email',
    'contact.message':  'Message',
    'contact.send':     'Send Message',
    'apps.cta_live':    'See it live',
  ...
  es: {
    ...
    'skills.resume':    'Descargar CV',
    'apps.title':       'Lo que construí',
    'apps.subtitle':    'Proyectos y herramientas que lancé.',
    'contact.title':    'Hablemos',
    'contact.subtitle': 'Completá el formulario y te llevo directo a WhatsApp.',
    'contact.name':     'Nombre',
    'contact.email':    'Email',
    'contact.message':  'Mensaje',
    'contact.send':     'Enviar mensaje',
    'apps.cta_live':    'Ver app',
    'apps.cta_github':  'GitHub'
  }
};
